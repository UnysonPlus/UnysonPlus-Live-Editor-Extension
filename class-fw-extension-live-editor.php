	...
	private function enqueue_shell_assets() {
		...
		wp_localize_script( 'fw-live-editor', '_fwLiveEditor', array(
			...
			'l10n'     => array(
				...
				'insert'      => __( 'Insert', 'fw' ),
				'insertGrid'  => __( 'Insert Grid', 'fw' ),
				'basic'       => __( 'Basic', 'fw' ),
				'block'       => __( 'Block', 'fw' ),
				'flexbox'     => __( 'Flexbox', 'fw' ),
				'blockDesc'   => __( 'A plain block container — children stack.', 'fw' ),
				'flexboxDesc' => __( 'A flex container — lay children in a row or column.', 'fw' ),
